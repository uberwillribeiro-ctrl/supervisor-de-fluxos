  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h2 className="text-xl font-bold text-slate-100">Casos Ativos</h2>
          <p className="text-xs text-slate-500 mt-0.5">Gestão e monitoramento de atendimentos</p>
        </div>

        <div className="flex items-center gap-2">
          {alertaCount > 0 && (
            <div className="flex items-center gap-1.5 text-xs text-amber-400 bg-amber-500/10 ring-1 ring-amber-500/20 rounded-xl px-3 py-1.5">
              ...
              <tr className="border-b border-slate-800">
                {[
                  ...
                  <th
                    key={col}
                    className={cn(
                      'px-3 py-3 text-left font-semibold uppercase tracking-wider text-slate-500',
                      col === 'Último Relatório' && 'text-indigo-400',
                    )}
                  >
                    {col}
                  </th>
                  ...
                  return (
                    <tr
                      ...
                      className={cn(
                        ...
                        inativo && 'border-l-2 border-amber-500',
                      )}
                    >
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Select
              ...
              onChange={(e) => setField('mesReferencia', e.target.value)}
            />
            <Select
              label="Perfil"
              options={[
            ...
            <Input
              ...
              onChange={(e) => setField('dataDocumento', e.target.value)}
            />
            <Input
              label="Data que Recebeu"
              type="date"
              value={form.dataRecebido}
              onChange={(e) => setField('dataRecebido', e.target.value)}
            />
          </div>
